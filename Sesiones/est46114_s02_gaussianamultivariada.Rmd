...
title: "S02 - Distribución Gaussiana Multivariada"
...
png("C:/Users/jcmo/Google Drive/Material.Cursos/EST46114/Sesiones/est46114/figuras/contour_nula.png", 490, 490)
...
![Contornos de distribucion gausiana.](C:/Users/jcmo/Google Drive/Material.Cursos/EST46114/Sesiones/est46114/figuras/contour_nula.png)
...
png("C:/Users/jcmo/Google Drive/Material.Cursos/EST46114/Sesiones/est46114/figuras/contour_positiva.png", 490, 490)
contour(x.points,y.points,z)
dev.off()
```
...
![Contornos de distribucion gausiana con covarianza positiva](C:/Users/jcmo/Google Drive/Material.Cursos/EST46114/Sesiones/est46114/figuras/contour_positiva.png)
...
png("C:/Users/jcmo/Google Drive/Material.Cursos/EST46114/Sesiones/est46114/figuras/contour_negativa.png", 490, 490)
contour(x.points,y.points,z)
dev.off()
```
...
![Contornos de distribucion gausiana con covarianza positiva](C:/Users/jcmo/Google Drive/Material.Cursos/EST46114/Sesiones/est46114/figuras/contour_negativa.png)
...
```{r summary, echo=TRUE}
data01 <- read.csv(file="C:/Users/jcmo/Google Drive/Material.Cursos/EST46114/Sesiones/est46114/datos/est46114_semana02.csv",header=TRUE)
summary(data01)
...
La funcion de verosimilitud para $(\mu,\Sigma)$ condicional en un conjunto de 
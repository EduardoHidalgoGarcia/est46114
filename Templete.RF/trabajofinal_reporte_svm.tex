...
\title{Titulo \thanks{Agradecimientos\ldots{}}  }



\author{\Large Autor 1 (CU 1)\vspace{0.05in} \newline\normalsize\emph{ITAM}   \and \Large Autor 2 (CU 2)\vspace{0.05in} \newline\normalsize\emph{ITAM}  }
...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Autor 1 (CU 1) (ITAM) and Autor 2 (CU 2) (ITAM)},
             pdfkeywords = {Temas\ldots{}},  
            pdftitle={Titulo},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
...
\textbf{\authorfont Autor 1 (CU 1)} \hskip 15pt \emph{\small ITAM}   \par \textbf{\authorfont Autor 2 (CU 2)} \hskip 15pt \emph{\small ITAM}   
...
\noindent Resumen\ldots{}


\vskip 8.5pt \noindent \emph{Keywords}: Temas\ldots{} \par
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{suppressMessages}\NormalTok{(}\KeywordTok{library}\NormalTok{(}\StringTok{"Zelig"}\NormalTok{))}
\KeywordTok{suppressMessages}\NormalTok{(}\KeywordTok{library}\NormalTok{(}\StringTok{"arm"}\NormalTok{))}

\ControlFlowTok{if}\NormalTok{ (}\KeywordTok{require}\NormalTok{(}\StringTok{"coefplot"}\NormalTok{)) \{}
    \KeywordTok{install.packages}\NormalTok{(}\StringTok{"coefplot"}\NormalTok{)}
\NormalTok{\}}
\KeywordTok{suppressMessages}\NormalTok{(}\KeywordTok{library}\NormalTok{(}\StringTok{"coefplot"}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{if}\NormalTok{ (}\OperatorTok{!}\KeywordTok{require}\NormalTok{(}\StringTok{"Zelig"}\NormalTok{)) \{}
    \KeywordTok{install.packages}\NormalTok{(}\StringTok{"Zelig"}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\ControlFlowTok{if}\NormalTok{ (}\OperatorTok{!}\KeywordTok{require}\NormalTok{(}\StringTok{"arm"}\NormalTok{)) \{}
    \KeywordTok{install.packages}\NormalTok{(}\StringTok{"arm"}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## Working directory is C:/Users/jcmo/Google Drive/Material.Cursos/EST46114/Sesiones
\end{verbatim}
...
\begin{figure}
\centering
\includegraphics{est46114_trabajofinal_reporte_svm_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\ControlFlowTok{if}\NormalTok{ (}\OperatorTok{!}\KeywordTok{require}\NormalTok{(}\StringTok{"stargazer"}\NormalTok{)) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{suppressMessages}\NormalTok{(}\KeywordTok{library}\NormalTok{(}\StringTok{"stargazer"}\NormalTok{))}
